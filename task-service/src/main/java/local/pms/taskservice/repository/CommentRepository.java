...
public interface CommentRepository extends JpaRepository<Comment, UUID> {
    ...
    Page<Comment> findAllByTaskIdAndParentCommentIdIsNull(UUID taskId, Pageable pageable);

    List<Comment> findAllByParentCommentIdInOrderByCreatedAtAsc(List<UUID> parentCommentIds);
