package local.pms.notificationservice.filter;
...
/**
 * Validates the Bearer JWT token on every incoming request and populates the Spring Security context.
 */
@Slf4j
@Component
...
public class JwtVerificationTokenFilter extends OncePerRequestFilter {
    ...
    private void validateTokenAndProceed(HttpServletRequest request, HttpServletResponse response, FilterChain chain, String token)
