...
import local.pms.projectservice.external.organization.client.OrganizationFeignClient;
 ...
 * by a circuit breaker and retry policy. Unlike the AI integration, this fails closed: any
 * failure to positively confirm membership (not-a-member, timeout, circuit open) denies access.
 */
@Slf4j
@Component
