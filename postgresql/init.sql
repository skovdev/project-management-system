...
CREATE USER project_management_system_organization_service_user WITH PASSWORD 'project_management_system_organization_service_password';
CREATE DATABASE project_management_system_organization_service_db;
GRANT ALL PRIVILEGES ON DATABASE project_management_system_organization_service_db to project_management_system_organization_service_user;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO project_management_system_organization_service_user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO project_management_system_organization_service_user;
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA public TO project_management_system_organization_service_user;
GRANT USAGE ON SCHEMA public TO project_management_system_organization_service_user;
GRANT CREATE ON SCHEMA public TO project_management_system_organization_service_user;
...
CREATE USER project_management_system_notification_service_user WITH PASSWORD 'project_management_system_notification_service_password';
CREATE DATABASE project_management_system_notification_service_db;
GRANT ALL PRIVILEGES ON DATABASE project_management_system_notification_service_db to project_management_system_notification_service_user;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO project_management_system_notification_service_user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO project_management_system_notification_service_user;
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA public TO project_management_system_notification_service_user;
GRANT USAGE ON SCHEMA public TO project_management_system_notification_service_user;
GRANT CREATE ON SCHEMA public TO project_management_system_notification_service_user;

ALTER DATABASE project_management_system_auth_service_db OWNER TO project_management_system_auth_service_user;
ALTER DATABASE project_management_system_organization_service_db OWNER TO project_management_system_organization_service_user;
...
ALTER DATABASE project_management_system_notification_service_db OWNER TO project_management_system_notification_service_user;