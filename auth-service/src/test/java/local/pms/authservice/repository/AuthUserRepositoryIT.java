...
/**
 * Integration tests for {@link AuthUserRepository} running against a real PostgreSQL
 * instance managed by Testcontainers.
 * Uses {@code @ServiceConnection} so Spring Boot auto-configures the datasource URL.
 */
@DataJpaTest
@Testcontainers
