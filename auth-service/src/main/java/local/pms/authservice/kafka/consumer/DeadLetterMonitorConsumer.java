...
public class DeadLetterMonitorConsumer {
    ...
    /**
     * Handles a dead-lettered record from any of this service's compensation topics.
     *
    ...
    @KafkaListener(
            topics = {
                    KafkaConstants.Topics.USER_DETAILS_CREATION_FAILED_DLT_TOPIC,
                    KafkaConstants.Topics.USER_DETAILS_DELETION_FAILED_DLT_TOPIC
            },
            groupId = KafkaConstants.GroupIds.AUTH_DLT_MONITOR_GROUP_ID,
            containerFactory = "dltKafkaListenerContainerFactory")
    public void onDeadLetter(ConsumerRecord<String, String> record) {
        // The payload is deliberately excluded: these DLT topics carry UserDetailsDto, which
        // includes PII (name, email) that must never be written to logs.
        log.error("""
